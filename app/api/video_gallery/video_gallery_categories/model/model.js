...
let videogallerycategoriesSchema = mongoose.Schema({
...
videogallerycategoriesSchema.pre('save', async function (next) {
...
module.exports = mongoose.model("video_gallery_categories", videogallerycategoriesSchema);
