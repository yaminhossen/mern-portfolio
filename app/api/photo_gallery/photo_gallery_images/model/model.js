...
let photogalleryimagesSchema = mongoose.Schema({
...
photogalleryimagesSchema.pre('save', async function (next) {
...
module.exports = mongoose.model("photo_gallery_images", photogalleryimagesSchema);
