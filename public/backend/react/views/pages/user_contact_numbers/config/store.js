...
export const async_actions = {
    ...
    [`fetch_all_data`]: createAsyncThunk(
        ...
        async (data, thunkAPI) => {
            ...
            let state = thunkAPI.getState().user_contact_number;
            let qparams = {
                page: state[`page`],
    ...
    [`store_${store_prefix}`]: createAsyncThunk(
        `user_contact_numbers/store_${store_prefix}`,
        async (form_data, thunkAPI) => {
            ...
            try {
                ...
                // console.log('from store user contact_numbers',error);
    ...
    [`edit_${store_prefix}`]: createAsyncThunk(
        `user_contact_numbers/edit_${store_prefix}`,
        async (form_data, thunkAPI) => {
            // console.log(thunkAPI);
            console.log('hoiche');
            try {
    ...
    [`details_${store_prefix}`]: createAsyncThunk(
        `user_contact_numbers/details_${store_prefix}`,
        async (id, thunkAPI) => {
            console.log(id);
            try {
    ...
    [`fetch_my_data`]: createAsyncThunk(
        ...
        async (params = 0, thunkAPI) => {
            // console.log(thunkAPI);
            const response = await axios.get(`${app_config.api_endpoint}/user-contact-numbers`);
