...
export const async_actions = {
    ...
    [`fetch_all_data`]: createAsyncThunk(
        ...
        async (data, thunkAPI) => {
            ...
            let state = thunkAPI.getState().content_comment_reply;
            let qparams = {
                page: state[`page`],
    ...
    [`store_${store_prefix}`]: createAsyncThunk(
        `content_comment_replies/store_${store_prefix}`,
    ...
    [`edit_${store_prefix}`]: createAsyncThunk(
        `content_comment_replies/edit_${store_prefix}`,
        async (form_data, thunkAPI) => {
            // console.log(thunkAPI);
            console.log('hoiche');
            try {
    ...
    [`details_${store_prefix}`]: createAsyncThunk(
        `content_comment_replies/details_${store_prefix}`,
        async (id, thunkAPI) => {
            console.log(id);
            try {
