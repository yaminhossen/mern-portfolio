                ...
                <div className="table_actions">
                    ...
                    <ul>
                        ...
                        </li>
                        {
                            data_store.show_active_data ?
                                <li>
                                    <a onClick={() => { event.preventDefault(); set_show_active_data(0) }} href="#/user" title="display data that has been deactivated" className="d-flex">
                                        <i className="material-symbols-outlined fill">keyboard_arrow_right</i>
                                        Deactive data
                                    </a>
                                </li>
                                :
                                <li>
                                    <a onClick={() => { event.preventDefault(); set_show_active_data(1) }} href="#/user" title="display data that has been deactivated" className="d-flex">
                                        <i className="material-symbols-outlined fill">keyboard_arrow_right</i>
                                        Active data
                                    </a>
                                </li>
