...
export const async_actions = {
    ...
    [`fetch_all_data`]: createAsyncThunk(
        ...
        async (data, thunkAPI) => {
            ...
            let state = thunkAPI.getState().user_profile_info;
            let qparams = {
                page: state[`page`],
    ...
    [`store_${store_prefix}`]: createAsyncThunk(
        `user_profile_infos/store_${store_prefix}`,
        async (form_data, thunkAPI) => {
            ...
            try {
                ...
                // console.log('from store user profile_infos',error);
    ...
    [`edit_${store_prefix}`]: createAsyncThunk(
        `user_profile_infos/edit_${store_prefix}`,
        async (form_data, thunkAPI) => {
            // console.log(thunkAPI);
            console.log('hoiche');
            try {
    ...
    [`details_${store_prefix}`]: createAsyncThunk(
        `user_profile_infos/details_${store_prefix}`,
        async (id, thunkAPI) => {
            console.log(id);
            try {
    ...
    [`fetch_my_data`]: createAsyncThunk(
        ...
        async (params = 0, thunkAPI) => {
            // console.log(thunkAPI);
            const response = await axios.get(`${app_config.api_endpoint}/user-profile-infos`);
