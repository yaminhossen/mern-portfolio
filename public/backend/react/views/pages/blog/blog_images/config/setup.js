...
let prefix = 'blog_image';
var setup = {
    prefix,
    route_prefix: 'blog-image',
    api_prefix: 'blog-image',
    layout_title: 'blog image management',
    all_page_title: 'All blog images',
    crate_page_title: 'Create blog image',
    edit_page_title: 'Edit blog image',
...
setup.actions.get_blog_images = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
