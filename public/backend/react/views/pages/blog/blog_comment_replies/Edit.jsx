...
function Edit() {
  ...
  const { get_blog_comment_replies, set_data, update_data } = setup.actions;

  useEffect(() => {
    get_blog_comment_replies(id);
      ...
      <div className="card list_card">
        <div className="card-header ">
          ...
          <div className="btns d-flex gap-2 align-items-center">
            <a href="#/blog-comment-reply" className="btn rounded-pill btn-outline-secondary">
