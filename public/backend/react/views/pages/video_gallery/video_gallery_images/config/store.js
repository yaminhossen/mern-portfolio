...
export const async_actions = {
    ...
    [`fetch_all_data`]: createAsyncThunk(
        ...
        async (data, thunkAPI) => {
            ...
            let state = thunkAPI.getState().video_gallery_image;
            let qparams = {
                page: state[`page`],
    ...
    [`store_${store_prefix}`]: createAsyncThunk(
        `video_gallery_images/store_${store_prefix}`,
    ...
    [`edit_${store_prefix}`]: createAsyncThunk(
        `video_gallery_images/edit_${store_prefix}`,
        async (form_data, thunkAPI) => {
            // console.log(thunkAPI);
            console.log('hoiche');
            try {
    ...
    [`details_${store_prefix}`]: createAsyncThunk(
        `video_gallery_images/details_${store_prefix}`,
        async (id, thunkAPI) => {
            console.log(id);
            try {
