...
function Edit() {
  ...
  const { get_setting_values, set_data, update_data } = setup.actions;

  useEffect(() => {
    get_setting_values(id);
  ...
  if(data_store){
    const{serial, value, date} = data_store;
    return (
      <div className="card list_card">
        <div className="card-header ">
          <h2 className="heading">Edit</h2>
          <div className="btns d-flex gap-2 align-items-center">
            <a href="#/setting-value" className="btn rounded-pill btn-outline-secondary">
